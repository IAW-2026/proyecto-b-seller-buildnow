                ...
                {stores.map((store) => {
                  ...
                  return (
                    <tr key={store.id} className={`hover:bg-zinc-50 transition-colors ${isSuspended ? 'bg-red-50/30' : ''}`}>
                      ...
                      <td className="px-6 py-4">
                        <span className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ring-1 ring-inset ${isSuspended ? 'bg-red-50 text-red-700 ring-red-600/10' :
